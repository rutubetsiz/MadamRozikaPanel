...
public class Helper
{
    public static string CategoryEnglish(int id)
    {
        switch (id)
        {
            case 1000: return "Politics";
            case 1007: return "Politics";
            case 1010: return "Politics";
            case 1012: return "Politics";
            case 1016: return "Politics";
            case 1017: return "Politics";
            case 1024: return "Politics";
            case 1025: return "Politics";
            case 1027: return "Politics";
            case 1029: return "Politics";
            case 1006: return "Lifestyle";
            case 1023: return "Technology";
            case 1030: return "Companies";
            case 1031: return "Education";
            case 1001: return "Economy";
            case 1008: return "Economy";
            case 1019: return "Economy";
            case 1026: return "Economy";
            case 1011: return "Business";
            case 1015: return "Business";
            case 1002: return "World";
            case 1018: return "World";
            case 1003: return "Sports";
            case 1020: return "Sports";
            case 1021: return "Sports";
            case 1005: return "Culture Arts";
            case 1009: return "Health";
            case 1013: return "Magazine";
            default: return "News";
        }
    }
    ...
    public static string CreateCaptchaImage(string Kod, int H, int W, string fonts, int Punto, int X, int Y, string BackgroundImage)
    {
        ...
        Random r = new Random();
        System.Drawing.Image img = System.Drawing.Image.FromFile(BackgroundImage); //Arka plan resmi captcha kodunun kolayca okunmasını önlemek için. Ne kadar karışık bir resim olursa o kadar iyidir.
    ...
    public static string CreateRandomPassword(int Length)
    {
        ...
        return Result; //Rnd.Next(Convert.ToInt32((Math.Pow(10, Length - 1))), Convert.ToInt32((Math.Pow(10, Length))) - 1).ToString();
    }
    #region mail
    ...
    public static string ToUpperFirstLetter(string Value)
    {
        ...
        if (Value != null)
        {
            ...
            {
                if (item.Length > 0)
                    ResultString += item.Substring(0, 1).ToUpper() + (item.Length > 1 ? item.Substring(1).ToLower() : "") + " ";
            }
        }
