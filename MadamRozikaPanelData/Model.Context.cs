...
namespace MadamRozikaPanelData
{
    ...
    public partial class MadamRozikaEntities : DbContext
    {
        ...
        public virtual int Sp_GetNewsListWithCategoryUrl(string categoryUrl)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sp_GetNewsListWithCategoryUrl", categoryUrlParameter);
        }
    }
}
